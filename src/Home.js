  ...
  return (
    <div style={{ backgroundColor: '#080404' }}>
      ...
      <div className="px-5 fw-light">
        ...
        <div className="row mt-2" id='our_philosophy'>
        ...
        <div id="carouselExampleSlidesOnly " className="carousel slide mt-5" data-bs-ride="carousel">
          <div className="carousel-inner" id='about_us'>
            {
        ...
        <div className="row mt-5 pt-5" id='commercial'>
          <div className="col-5 text-white" >
      ...
      <div className='container px-5 text-white' id='contact_us'>
        <div className='mx-5 mt-5 py-5 row'>
          ...
          <div className='col-4 pt-4' >
            {footerRightLink.map(data => {
              return (
                <div className='my-2'>
                  <a href={`#${data.href}`} className='text-decoration-none'>
                    <img src='/assets/icons/ArrowBullet.png' />
                    <span className='ms-2 text-white ' style={{ fontSize: '20px' }}>{data.text}</span>
                  </a>
                </div>
